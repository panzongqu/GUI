	...
	public ConfigureSerialGui() {
		...
		}
		{
			...
			cbbpanel.setLayout(new GridLayout(0, 1, 10, 5));
			{
				...
				po_comboBox.setName("po_comboBox");
			...
			}
			{
				...
				ba_comboBox.setName("ba_comboBox");
			...
			}
			{
				...
				da_comboBox.setName("da_comboBox");
			...
			}
			{
				...
				pa_comboBox.setName("pa_comboBox");
			...
			}
			{
				...
				st_comboBox.setName("st_comboBox");
